...
t0=0.388
event=26
suffix41=0 #yoko Last digit of the .wvf file name
suffix42=0 #lecroy last digit og the .trc file name
suffix43=0 #lecroy last digit og the .trc file name
suffix44=0 #lecroy last digit og the .trc file name
suffix48=0 #lecroy last digit og the .trc file name
suffix50=0 #lecroy last digit og the .trc file name
offset=0.05
duplicate_delay=0
...
#Yoko
yoko_fileName = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope41/APD000"+str(suffix41)
...
##LeCroy
#Diode 1
lecroy_fileName_Scope43_APD1 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope43/C1AC0000"+str(suffix43)+".trc"
...
#Diode 2
lecroy_fileName_Scope43_APD2 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope43/C2AC0000"+str(suffix43)+".trc"
...
#Diode 3
lecroy_fileName_Scope43_APD3 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope43/C3AC0000"+str(suffix48)+".trc"
...
#Diode 5
lecroy_fileName_Scope43_APD4 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C4AC0000"+str(suffix48)+".trc"
...
#Diode 5
lecroy_fileName_Scope44_APD5 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C1AC0000"+str(suffix48)+".trc"
...
#Diode 6
lecroy_fileName_Scope44_APD6 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C2AC0000"+str(suffix48)+".trc"
...
#Diode 7
lecroy_fileName_Scope44_APD7 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C3AC0000"+str(suffix48)+".trc"
...
#Diode 8
lecroy_fileName_Scope44_APD8 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C4AC0000"+str(suffix48)+".trc"
...
#Diode 9
lecroy_fileName_Scope48_APD9 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C1AC0000"+str(suffix48)+".trc"
...
#Diode 10
lecroy_fileName_Scope48_APD10 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C2AC0000"+str(suffix48)+".trc"
...
#Diode 11
lecroy_fileName_Scope48_APD11 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C3AC0000"+str(suffix48)+".trc"
...
#Diode 12
lecroy_fileName_Scope48_APD12 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope48/C4AC0000"+str(suffix48)+".trc"
...
#Diode 13
lecroy_fileName_Scope50_APD13 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope50/C1AC0000"+str(suffix50)+".trc"
...
#Diode 14
lecroy_fileName_Scope50_APD14 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope50/C2AC0000"+str(suffix50)+".trc"
...
#Diode 15
lecroy_fileName_Scope50_APD15 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope50/C3AC0000"+str(suffix50)+".trc"
...
#Diode 16
lecroy_fileName_Scope50_APD16 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope50/C4AC0000"+str(suffix50)+".trc"
...
#Diode 17
lecroy_fileName_Scope42_APD17 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope42/C1AC0000"+str(suffix42)+".trc"
...
#Diode 18
lecroy_fileName_Scope42_APD18 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope42/C2AC0000"+str(suffix42)+".trc"
...
#Diode 19
lecroy_fileName_Scope42_APD19 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope42/C3AC0000"+str(suffix42)+".trc"
...
#Diode 20
lecroy_fileName_Scope42_APD20 = "/Volumes/Promise 12TB RAID5/2015 Data/0"+str(date)+"/Scope42/C4AC0000"+str(suffix42)+".trc"
...
APD_16=f.get_trace_data(header,13,t0,tf)
#
...
def noise_analysis(x,y,fs,t0):
    ...
    return ten_percent_ind,twenty_percent_ind,fifty_percent_ind,eighty_percent_ind,ninety_percent_ind,risetime_90_10
