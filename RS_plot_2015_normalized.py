...
suffix26=suffix #lecroy last digit og the .trc file name
...
mywriter.writerow(['Diode 2 to Diode 32 speed at 20%',\
                   'Diode 2 to Diode 32 speed at 50%',\
                   'Diode 2 to Diode 32 speed at 80%',\
                   'Diode 32 10-90% risetime',\
                   'Diode 2 10-90% risetime']) #Each columns title
...
APD_32.data=LPF(APD_32.dataTime,APD_32.data,100e6)
segments_Scope43_APD2[seg]=LPF(seg_time_Scope43_APD2,segments_Scope43_APD2[seg],100e6)

waveforms=allspeeds((APD_32.dataTime-yoko_pretrigger),APD_32.data,\
                    (seg_time_Scope43_APD2-lecroy_pretrigger),segments_Scope43_APD2[seg],\
                    100e6,100e6,-5e-3,935,1,duplicate_delay)

plt.plot((waveforms[0])*1e3,waveforms[1])
plt.plot((waveforms[2])*1e3,waveforms[3])
plt.legend(['Diode 32 (1 km)','Diode 2 (4 m)'], loc=0)
plt.xlabel('Time (ms)')
